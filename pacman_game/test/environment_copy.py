...
class Environment:
    ...
    def draw(self):
        ...
        wall_10 = pygame.image.load('pacman_game/images/sprite_00.png').convert_alpha()
        wall_11 = pygame.image.load('pacman_game/images/sprite_01.png').convert_alpha()
        wall_12 = pygame.image.load('pacman_game/images/sprite_02.png').convert_alpha()
        wall_13 = pygame.image.load('pacman_game/images/sprite_03.png').convert_alpha()
        wall_14 = pygame.image.load('pacman_game/images/sprite_04.png').convert_alpha()
        wall_15 = pygame.image.load('pacman_game/images/sprite_05.png').convert_alpha()
        wall_16 = pygame.image.load('pacman_game/images/sprite_06.png').convert_alpha()
        wall_17 = pygame.image.load('pacman_game/images/sprite_07.png').convert_alpha()
        wall_18 = pygame.image.load('pacman_game/images/sprite_08.png').convert_alpha()
        wall_19 = pygame.image.load('pacman_game/images/sprite_09.png').convert_alpha()
        wall_20 = pygame.image.load('pacman_game/images/sprite_10.png').convert_alpha()
        wall_21 = pygame.image.load('pacman_game/images/sprite_11.png').convert_alpha()
        wall_22 = pygame.image.load('pacman_game/images/sprite_12.png').convert_alpha()
        wall_23 = pygame.image.load('pacman_game/images/sprite_13.png').convert_alpha()
        wall_24 = pygame.image.load('pacman_game/images/sprite_14.png').convert_alpha()
        wall_25 = pygame.image.load('pacman_game/images/sprite_15.png').convert_alpha()
        wall_26 = pygame.image.load('pacman_game/images/sprite_16.png').convert_alpha()
        wall_27 = pygame.image.load('pacman_game/images/sprite_17.png').convert_alpha()
